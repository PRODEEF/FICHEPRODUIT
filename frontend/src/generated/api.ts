...
export interface components {
  schemas: {
    ...
    /** @enum {string} */
    RefineTemplateFieldsSource: 'csv_import' | 'product_page' | 'manual';
    ...
    SiteAnalysis: {
      ...
      brandsList?: string[];
      /**
       * Short French phrase describing what the shop sells (for UI).
       * @example des produits de kitesurf
       */
      verticalSummary?: string;
      /**
       * Catalog category labels when the shop spans several verticals.
       * @example ["Kitesurf","Wing foil"]
       */
